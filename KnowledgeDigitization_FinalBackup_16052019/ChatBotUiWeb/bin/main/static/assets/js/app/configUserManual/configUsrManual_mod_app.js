fordApp.controller('configUsrManualController', ['$scope','$timeout','$translate','configUsrManualService','$route','$window','$anchorScroll',
	'$rootScope','$filter','$http','$localStorage',
	function($scope,$timeout,$translate, configUsrManualService,$route,$window,$anchorScroll,$rootScope,$filter,$http,$localStorage) {
