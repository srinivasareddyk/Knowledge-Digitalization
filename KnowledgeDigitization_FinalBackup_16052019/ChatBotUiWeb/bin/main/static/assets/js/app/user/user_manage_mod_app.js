...
fordApp.controller('manageUserController', [
		'$scope',
		'userManageService',
		'$window',
		'$timeout',
		'$translate',
		'$rootScope',
		function($scope, userManageService, $window, $timeout,
				$translate, $rootScope) {
			$scope.statusList = [ {
				key : null,
				value : "Please Select"
							...
							this.searchUserService = function(data) {
								return new Promise(
										function(resolve, reject) {
											...
											$http
													.post(
															'http://35.154.237.162:9060/ChatBotService/User/ManageUserSearch',
															data)
													.then(
															function(response) {
							...
							this.searchManageUpdate = function(data) {
								...
								return new Promise(
										function(resolve, reject) {
											...
											$http
													.post(
															'http://35.154.237.162:9060/ChatBotService/User/ManageUserUpdateSearch',
															data)
							...
							this.saveUpdateUser = function(data) {
								...
								return new Promise(
										function(resolve, reject) {
											...
											$http
													.post(
															'http://35.154.237.162:9060/ChatBotService/User/ManageUserSave',
															data)
													.then(function(response) {
														resolve(response.data);
													}, function(error) {
							...
							this.getRoles = function() {
								return new Promise(
										function(resolve, reject) {
											...
											$http
													.post(
															'http://35.154.237.162:9060/ChatBotService/User/getRoles')
													.then(function(response) {
														resolve(response.data);
													}, function(error) {
														reject([]);
							...
							this.getAreaCodes = function() {
								return new Promise(
										function(resolve, reject) {
											...
											$http
													.post(
															'http://35.154.237.162:9060/ChatBotService/User/getAreaCode')
													.then(function(response) {
														resolve(response.data);
													}, function(error) {
														reject([]);
