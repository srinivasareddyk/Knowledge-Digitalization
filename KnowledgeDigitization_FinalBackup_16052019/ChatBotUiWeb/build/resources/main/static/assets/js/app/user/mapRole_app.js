 fordApp.controller('MapRoleController', ['$scope','$http','$filter','$timeout','$translate','mapRoleService','$route','$window','$anchorScroll','$rootScope',
	function($scope,$http,$filter,$timeout,$translate, mapRoleService,$route,$window,$anchorScroll,$rootScope) {
	 $scope.selected = []; 
	    $scope.dataadd=false;
	    ...
	    $scope.loadFunctionName=function(screen)
	    {
	      ...
	      $scope.downloadExcelMapRole=function()
	      {
	             ...
	             if($scope.rowCollection.length>0)
	                ...
	                $http.post("http://35.154.237.162:9060/ChatBotService/Role/exportExcelMapRole",$scope.mRole).then(function(response) {
	                    if (response) {
 ...
 fordApp.service("mapRoleService",['$http',function($http){
		
		this.srchMapRole = function(data) { 
			return new Promise(function(resolve,reject){
				$http.post('http://35.154.237.162:9060/ChatBotService/Role/MapRoleSearch',data)
				.then(
					function(response){
		...
		this.saveMapRole = function(data) { 
			return new Promise(function(resolve,reject){
				...
				$http.post('http://35.154.237.162:9060/ChatBotService/Role/MapRoleSave',data).then(
					function(response){
						resolve(response.data);
					},
					function(error){
		...
		this.updateMapRole = function(data) { 
			return new Promise(function(resolve,reject){
				...
				$http.post('http://35.154.237.162:9060/ChatBotService/Role/MapRoleUpdate',data).then(
					function(response){
						resolve(response.data);
					},
					function(error){
		...
		this.deleteMapRole = function(data) { 
			return new Promise(function(resolve,reject){
				...
				$http.post('http://35.154.237.162:9060/ChatBotService/Role/MapRoleDelete',data).then(
					function(response){
						resolve(response.data);
					},
					function(error){
		...
		this.getScreenNames = function() {
			return new Promise(
					function(resolve, reject) {
						...
						$http
								.post(
										'http://35.154.237.162:9060/ChatBotService/Role/getScreenNames')
		...
		this.getScreenNamesDT = function() {
			return new Promise(
					function(resolve, reject) {
						...
						$http
								.post(
										'http://35.154.237.162:9060/ChatBotService/Role/getScreenNamesDT')
								.then(function(response) {
									resolve(response.data);
								}, function(error) {
									reject([]);
		...
		this.getFunctionNames = function() {
			return new Promise(
					function(resolve, reject) {
						...
						$http
								.post(
										'http://35.154.237.162:9060/ChatBotService/Role/getFunctionNames')
								.then(function(response) {
									resolve(response.data);
								}, function(error) {
									reject([]);
		...
		this.getFunctionNamesbasedOnScreen = function(data) {
			return new Promise(
					function(resolve, reject) {
						...
						$http
								.post(
										'http://35.154.237.162:9060/ChatBotService/Role/getFunctionNamesBasedOnScreen',data)
								.then(function(response) {
									resolve(response.data);
								}, function(error) {
									reject([]);
		...
		this.getRoles = function() {
			return new Promise(
					function(resolve, reject) {
						...
						$http
								.post(
										'http://35.154.237.162:9060/ChatBotService/Role/getRoles')
								.then(function(response) {
									resolve(response.data);
								}, function(error) {
									reject([]);
 ...
 fordApp.directive("limitTo", [function() {
	    return {
	        restrict: "A",
