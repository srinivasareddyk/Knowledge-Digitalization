...
fordApp.controller('requestUserDetailsDatatable', ['$scope','userRequestService','$window','$timeout','$translate','$rootScope',function($scope,userRequestService,$window,$timeout,$translate,$rootScope) {
	var dt=new Date();
...
fordApp.service("userRequestService",['$http',function($http){
	
	this.getRequestData = function() { 
		return new Promise(function(resolve,reject){
			
			$http.post('http://35.154.237.162:9060/ChatBotService/User/RequestUserSearch').then(
				function(response){
	...
	this.searchRequestUpdate = function(data) {
		...
		return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/RequestUserUpdateSearch',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.approveUser =function(data)
	{
        ...
        return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/ApproveUserSave',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.denyUser =function(data)
	{
        ...
        return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/DenyUserSave',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
...
fordApp.controller('approveDenyUpdateController', ['$scope','$window','userRequestService','$rootScope',function($scope,$window,userRequestService,$rootScope) {//alert('hi');
