...
fordApp.controller('UpdateUserController', ['$scope','userUpdateService','$timeout','$translate','$rootScope',function($scope,userUpdateService,$timeout,$translate,$rootScope) {
...
fordApp.service("userUpdateService",['$http',function($http){
	this.searchUpdate = function(data) {
		 
		return new Promise(function(resolve,reject){
			console.log(data);
			$http.post('http://35.154.237.162:9060/ChatBotService/User/UpdateUserSearch',data).then(
				function(response){
	...
	this.updateUserService=function(data)
	{
        ...
        return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/UpdateUser',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.saveUserService=function(data)
	{
        ...
        return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/SaveUserReg',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getAreaCodes=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getAreaCode').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getRoles=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getRoles').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getCountries=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getCountries').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getLanguages=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getLanguages').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getRolesReg=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getRoleList').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getCountriesReg=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getCountriesReg').then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.getLanguagesReg=function()
	{
      return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/User/getLanguagesReg').then(
				function(response){
					resolve(response.data);
				},
				function(error){
...
fordApp.controller('UserRegController', ['$scope','userUpdateService','$timeout','$translate','$rootScope',function($scope,userUpdateService,$timeout,$translate,$rootScope) {
