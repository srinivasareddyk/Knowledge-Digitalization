...
fordApp.controller('userManualController',['$scope','$rootScope','$http','userManualService',function($scope,$rootScope,$http,userManualService){
	  $scope.getUserManuals = function() {
		  userManualService.getUserManuals("http://35.154.237.162:9060/ChatBotService")
			.then(
				function(data){
...
$(function(){
    ...
    /*	event.preventDefault();*/
        ...
        if(screenId!=undefined)
        	{
        window.open('http://35.154.237.162:9060/ChatBotService/sfh/downloadManFile?screenId='+screenId, '_blank');
        	}
        else{
