 ...
 fordApp.controller('editCtrlLayout',  ['$scope' ,'userService','$http',function($scope,userService,$http)  { 
	 ...
	 .service("userService",['$http',function($http){
			...
			this.srchUserCount = function(data) { 
				return new Promise(function(resolve,reject){
					$http.get('http://35.154.237.162:9060/EsipService/User/UserDtlList/Count').then(
						function(response){
			...
			this.srchUserAllServ = function(data) { 
				return new Promise(function(resolve,reject){
					$http.get('http://35.154.237.162:9060/EsipService/User/UserDtlList').then(
						function(response){
							resolve(response.data);
						},
						function(error){
