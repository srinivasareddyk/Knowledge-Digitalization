(function(ng) {
  //angular.module('myApp', ['smart-table', 'ui.bootstrap'])
    fordApp.controller('dataTableLayout', ['$scope', function($scope) {//alert('hi');
      var
    ...
    .directive('stSelectDistinct', [function() {
      return {
        ...
        template: '<select class="classic" ng-model="selectedOption" ng-change="optionChanged(selectedOption)" ng-options="opt for opt in distinctItems"></select>',
    ...
    .directive('stSelectMultiple', [function() {
      return {
        ...
        templateUrl: '/EsipWeb/views/stSelectMultiple.html',
        link: function(scope, element, attr, table) {
          scope.dropdownLabel = '';
