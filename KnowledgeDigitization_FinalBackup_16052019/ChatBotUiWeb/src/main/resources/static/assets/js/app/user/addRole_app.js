fordApp.controller('AddRoleController', ['$scope','$http','$filter','$timeout','$translate','addRoleService','$route','$window','$anchorScroll','$rootScope',
	function($scope,$http,$filter,$timeout,$translate, addRoleService,$route,$window,$anchorScroll,$rootScope) {
	      ...
	      $scope.downloadExcelAddRole = function() {
	    	  ...
	    	  //alert($scope.rowCollection); 
	             if($scope.rowCollection.length>0)
	                ...
	                $http.post("http://35.154.237.162:9060/ChatBotService/Role/exportExcelAddRole",$scope.addRole).then(function(response) {
	                    if (response) {
...
fordApp.service("addRoleService",['$http',function($http){
	
	this.srchAddRole = function() { 
		return new Promise(function(resolve,reject){
			$http.post('http://35.154.237.162:9060/ChatBotService/Role/AddRoleSearch')
			.then(
				function(response){
	...
	this.saveAddRole = function(data) { 
		return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/Role/AddRoleSave',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
	...
	this.updateAddRole = function(data) { 
		return new Promise(function(resolve,reject){
			...
			$http.post('http://35.154.237.162:9060/ChatBotService/Role/AddRoleUpdate',data).then(
				function(response){
					resolve(response.data);
				},
				function(error){
